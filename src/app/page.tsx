    ...
    <main>
      <section className='seccion-principal'>
        <section className='SP-textos'>
          <h2>Si puedes imaginarlo podemos subliminarlo</h2>
          <br />
          <p>
        ...
        <section>
          <Image src='/src/images/taza-logo.jpeg' alt='' />
        </section>
      </section>
      <section className='testimonios'>
        <h2>Testimonios</h2>
        <section className='tesminonios-seccion'>
          <section className='testimonios-perfiles'>
            <Image src='/src/images/Testimonio2.jpg' alt='' />
            <p>NOMBRE</p>
            <p>
